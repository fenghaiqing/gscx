...
bb.num=$("<input class=\"pagination-num\" type=\"text\" value=\"1\" size=\"2\"><button id='go' type='button' style=\"margin-right:2px;\">GO</button>").appendTo(tr).wrap("<td></td>");
$("button[id='go']").click(function(){
	
	
//var _a9=parseInt($("input[class='pagination-num']").val())||1;
	var _a9=parseInt($(this).parent().parent().find('.pagination-num').val())||1;
...
_9c0(this,q);
}},currentText:"Today",cleanText:"Clean",closeText:"Close",

okText:"Ok",buttons:[{text:function(_9d5){
...
// session timeout, go to login page.#add by guanyuzhuang
$.ajaxSetup({
complete:function(XMLHttpRequest,textStatus){
var sessionstatus=XMLHttpRequest.getResponseHeader("sessionstatus");
if(sessionstatus=='timeout'){
$.messager.confirm('提示',"会话超时，请重新登陆!",function(r){
var top = getTopWinow();
top.location.href = "http://"+window.location.host+"/income/";
});
}}
});
