...
<div><h1><img src="${ctx}/static/images/manage/migu_index.jpg"></h1></div>
    <div class="row">
        <h3 class="h3 text-center">实际收入出账单</h3>
        <h5 class="h5   col-sm-offset-9"><label style=" color: #2e6da4">实际收入编号：</label>${incomeManager.incomeManagerId}</h5>
        <h4 class="h4 text-left col-sm-offset-1" style="color: #2e6da4"><b>实际收入详情</b></h4>
        ...
        <div class="col-sm-10">
            <table style="border-collapse:separate; border-spacing:0px 20px;">
	            ...
	            <tr>
	                ...
	                <td style="text-align:left" width="150px" ></td>
	            	<td style="text-align:left;font-weight:bold" width="140px">实际收入<br>报账月份：</td>
	                <td style="text-align:left" width="250px" >${incomeManager.bzCycleReal }</td>
	            </tr>
            	<tr>
	            ...
	            <tr>
	            	<td style="text-align:left;font-weight:bold" width="140px">实际收入<br>(含税)：</td> 
	            	<td style="text-align:left" width="250px" >${realIncome }</td>
	            	<td style="text-align:left" width="150px" ></td>
	            	<td style="text-align:left;font-weight:bold" width="140px">实际收入<br>(不含税)：</td> 
	            	<td style="text-align:left" width="250px" >${realExclusiveTax}</td>
	            </tr>    
	            <tr>
	            	<td style="text-align:left;font-weight:bold" width="140px">税率：</td> 
	            	<td style="text-align:left" width="250px" >${incomeManager.realIncomeTax }</td>
	            	<td style="text-align:left" width="150px" ></td>
	            	<td style="text-align:left;font-weight:bold" width="140px">税额：</td> 
	            	<td style="text-align:left" width="250px" >${realAmount }</td>
	            </tr>
	            <tr>
	                <td style="text-align:left;font-weight:bold" width="140px">请购单或呈批件<br>文件名：</td>
	                <td style="text-align:left" width="250px" >${miguProject.requisitionFileName }</td>
	                <td style="text-align:left" width="150px" ></td>
	            	<td style="text-align:left;font-weight:bold" width="140px">OA审批截图<br>文件名：</td> 
	            	<td style="text-align:left" width="250px" >${miguProject.oaScreenFileName }</td>
	            </tr>
	            <tr>
	                <td style="text-align:left;font-weight:bold" width="140px">是否需要开票：</td>
	                <td style="text-align:left" width="250px" >${incomeManager.isNeedBill }</td>
	                <td style="text-align:left" width="150px" ></td>
	                <td style="text-align:left;font-weight:bold" width="140px">收入凭证：</td> 
	                <td style="text-align:left" width="250px" >${incomeManager.fileName }</td>
	            </tr>
	        </table>   
            <p style="padding-top: 20px"><label >说明：</label>${incomeManager.realExplain }</p>
        </div>
        <div class="col-sm-1"></div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-10">  <table class="table table-bordered">
         ...
         <c:forEach var="item" items="${deatailList }">
          <tr>
                ...
                <td><fmt:formatNumber type="number" value="${item.porductNumber }"	
