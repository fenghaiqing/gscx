...
<script type="text/javascript" src="${ctx}/static/js/manage/systemManage/incomeDiffShow.js"></script>
...
<body>
	...
	<div id="tb" style="padding:4px 5px;">
        	...
        	&nbsp;&nbsp;业务账期
        	<input class="easyui-datebox" name="q_month_start" id="q_month_start" style="width: 80px;" data-options="editable:false"/>
        	&nbsp;-&nbsp;
        	<input class="easyui-datebox" name="q_month_end" id="q_month_end" style="width: 80px;" data-options="editable:false"/>
